<main class="main-dashboard">
    <div class="dashboard-sidebar">
        <div class="dashboard-links">
            ...
            <!-- add links search - do anomalies check - display using the current method of viewing anomalies-->
    ...
    <section class="dashboard-content">
        ...
        <form class="d-flex" role="search" action="patients" method="GET">
...
<!--                        <td>--><?php //= htmlspecialchars($patient['firstname']) ?><!--</td>-->
<!---->
<!--                         <td>--><?php //= htmlspecialchars($patient['lastname']) ?><!--</td>-->
